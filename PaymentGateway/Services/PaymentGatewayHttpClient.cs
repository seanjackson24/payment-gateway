...
namespace PaymentGateway.ApiClient
{
	public interface IPaymentGatewayHttpClient
	{
		...
		Task<PaymentRetrievalResponse> RetrievePaymentDetails(PaymentRetrievalRequest request, string url, CancellationToken cancellationToken);
	}
	...
	public class PaymentGatewayHttpClient : IPaymentGatewayHttpClient
	{
		...
		// TODO: URLs
		public async Task<PaymentRetrievalResponse> RetrievePaymentDetails(PaymentRetrievalRequest request, string url, CancellationToken cancellationToken)
		{
			if (request is null)
			{
